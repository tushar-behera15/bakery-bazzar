        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="relative pt-12 pb-20 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <Link href="/shops" className="inline-flex items-center text-sm font-bold text-muted-foreground hover:text-primary transition-colors mb-8 group">
                        <ChevronLeft className="mr-1 h-4 w-4 transition-transform group-hover:-translate-x-1" />
                        Back to all bakeries
                    </Link>

                    <div className="flex flex-col md:flex-row items-center md:items-end gap-8">
                        <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-[2.5rem] overflow-hidden border-4 border-background shadow-premium shrink-0">
                        ...
                        <div className="flex-1 text-center md:text-left space-y-4">
                            ...
                            <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-foreground">{shop.name}</h1>
                            <p className="text-lg md:text-xl text-muted-foreground font-medium max-w-2xl">{shop.tagline}</p>
                        </div>
                    </div>
                </div>
            </div>
